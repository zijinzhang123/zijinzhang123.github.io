...
- Selected for INFORMS Minority Issues Forum Poster Competition 2025 [\[poster\]](/public/Poster_MIF_Rethinking_College.pdf)
...
1. [Too Big to Wait? Capacity Scaling under Congestion Signals](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3628484), with Yang Li, Daniel Zhuoyu Long, Rowan Wang, and Zhenkun Xu[^^dagger]. Revision at **Production and Operations Management**
...
1. [Non-Adaptive Query Optimization for Multi-LLM Classification: Hardness and Approximation](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6916600), with Arlen Dean, Stefanus Jasin, and Yuqing Liu[^^dagger]. Under review

1. [Rethinking Visibility: The Distribution of Visible and Invisible Public Goods in Autocracies](), with Jingyang Rui[^^dagger] and Weikun Yang. Working paper
